...
def inference_deep(image, num_of_templates):
    """Build a deeper U-net
    ...
    # pool15
    pool15 = tf.nn.max_pool(value=conv14,
                            ksize=[1, 2, 2, 1],
                            strides=[1, 2, 2, 1],
                            padding='SAME',
                            name='pool15')
    ...
    # up_conv18
    up_conv18 = _upconv_layer(scope_name='up-conv18',
                              kernal_shape=[2, 2, n5, n6],
                              kernal_stddev=std,
                              kernal_wd=None,
                              inputs=conv17,
                              output_shape=conv14.get_shape().as_list(),
                              strides=2,
                              initial_biases=biases)
    
    # copy and concatenate
    copy_and_concat1 = _copy_and_concat(up_conv18, conv14)
    
    # conv19
    conv19 = _conv_layer(scope_name='conv19',
                         kernal_shape=[3, 3, n6, n5],
                         kernal_stddev=std,
                         kernal_wd=None,
                         inputs=copy_and_concat1,
                         biases_shape=[n5],
    ...
    # copy and concatenate
    copy_and_concat2 = _copy_and_concat(up_conv21, conv11)
    ...
    # copy and concatenate
    copy_and_concat3 = _copy_and_concat(up_conv24, conv8)
    ...
    # up_conv27
    up_conv27 = _upconv_layer(scope_name='up-conv27',
                              kernal_shape=[2, 2, n2, n3],
                              kernal_stddev=std,
                              kernal_wd=None,
                              inputs=conv26,
    ...
    # copy and concatenate
    copy_and_concat4 = _copy_and_concat(up_conv27, conv5)
    
    # conv28
    conv28 = _conv_layer(scope_name='conv28',
                        kernal_shape=[3, 3, n3, n2],
                        kernal_stddev=std,
                        kernal_wd=None,
                        inputs=copy_and_concat4,
    ...
    # conv29
    conv29 = _conv_layer(scope_name='conv29',
                        kernal_shape=[3, 3, n2, n2],
                        kernal_stddev=std,
                        kernal_wd=None,
                        inputs=conv28,
    ...
    # up_conv30
    up_conv30 = _upconv_layer(scope_name='up-conv30',
                              kernal_shape=[2, 2, n1, n2],
                              kernal_stddev=std,
                              kernal_wd=None,
                              inputs=conv29,
    ...
    # copy and concatenate
    copy_and_concat5 = _copy_and_concat(up_conv30, conv2)
    
    # conv31
    conv31 = _conv_layer(scope_name='conv31',
                        kernal_shape=[3, 3, n2, n1],
                        kernal_stddev=std,
                        kernal_wd=None,
                        inputs=copy_and_concat5,
                        biases_shape=[n1],
                        initial_biases=biases)
    
    # conv32
    conv32 = _conv_layer(scope_name='conv32',
                        kernal_shape=[3, 3, n1, n1],
                        kernal_stddev=std,
                        kernal_wd=None,
                        inputs=conv31,
    ...
    # conv33
    conv33 = _conv_layer(scope_name='conv33',
                        kernal_shape=[3, 3, n1, 2],
                        kernal_stddev=std,
                        kernal_wd=None,
                        inputs=conv32,
...
def inference_simple(image, num_of_templates):
    """Build the U-net, delete some conv layers.
    ...
    # conv3
    conv3 = _conv_layer(scope_name='conv3',
                        kernal_shape=[3, 3, n2, n3],
                        kernal_stddev=std,
                        kernal_wd=None,
                        inputs=pool2,
    ...
    # pool3
    pool3 = tf.nn.max_pool(value=conv3,
                          ksize=[1, 2, 2, 1],
                          strides=[1, 2, 2, 1],
                          padding='SAME',
                          name='pool3')
    ...
    # pool4
    pool4 = tf.nn.max_pool(value=conv4,
                            ksize=[1, 2, 2, 1],
                            strides=[1, 2, 2, 1],
                            padding='SAME',
                            name='pool4')
    ...
    # up_conv1
    up_conv1 = _upconv_layer(scope_name='up-conv1',
                              kernal_shape=[2, 2, n4, n5],
                              kernal_stddev=std, 
                              kernal_wd=None,
                              inputs=conv5,
    ...
    # copy and concatenate
    copy_and_concat1 = _copy_and_concat(up_conv1, conv4)
    
    # conv6
    conv6 = _conv_layer(scope_name='conv6',
                        kernal_shape=[3, 3, n5, n4],
                        kernal_stddev=std,
                        kernal_wd=None,
                        inputs=copy_and_concat1,
    ...
    # up_conv2
    up_conv2 = _upconv_layer(scope_name='up-conv2',
                              kernal_shape=[2, 2, n3, n4],
                              kernal_stddev=std,
                              kernal_wd=None,
                              inputs=conv6,
    ...
    # copy and concatenate
    copy_and_concat2 = _copy_and_concat(up_conv2, conv3)
    ...
    # up_conv3
    up_conv3 = _upconv_layer(scope_name='up-conv3',
                              kernal_shape=[2, 2, n2, n3],
                              kernal_stddev=std,
                              kernal_wd=None,
                              inputs=conv7,
    ...
    # copy and concatenate
    copy_and_concat3 = _copy_and_concat(up_conv3, conv2)
    ...
    # up_conv4
    up_conv4 = _upconv_layer(scope_name='up-conv4',
                              kernal_shape=[2, 2, n1, n2],
                              kernal_stddev=std,
                              kernal_wd=None,
                              inputs=conv8,
                              output_shape=conv1.get_shape().as_list(),
                              strides=2,
                              initial_biases=biases)
    
    # copy and concatenate
    copy_and_concat4 = _copy_and_concat(up_conv4, conv1)
    
    # conv9
    conv9 = _conv_layer(scope_name='conv9',
                        kernal_shape=[3, 3, n2, n1],
                        kernal_stddev=std,
                        kernal_wd=None,
                        inputs=copy_and_concat4,
...
def train(loss, global_step):
    ...
    """
    lr = tf.train.exponential_decay(INITIAL_LEARNING_RATE, global_step, DECAY_STEPS, DECAY_FACTOR, True)
    opt = tf.train.GradientDescentOptimizer(lr)
    train_op = opt.minimize(loss, global_step)
    return train_op

def evaluate(pos_map, x, sess, lower, upper, useGTData, plot, threshold):
    scores = {}
    scores['dc'] = 0.
    scores['jc'] = 0.
    scores['ravd'] = 0.
    ...
    for i in range(lower, upper):
        ...
        while j < NUM:
            ...
            pos_array_threshold[pos_array_threshold > threshold] = 1
            pos_array_threshold[pos_array_threshold <= threshold] = 0
            # plot part
            if plot:
                plt.subplot(3, 2, 1)
